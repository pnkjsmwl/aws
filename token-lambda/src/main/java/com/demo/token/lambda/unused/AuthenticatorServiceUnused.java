...
import com.demo.token.authenticator.service.JWEGenerator;
import com.demo.token.authenticator.service.JWEValidator;
...
@RestController
public class AuthenticatorServiceUnused  {
	...
	@Autowired
	public AuthenticatorServiceUnused(JWEGenerator jweGenerator, JWEValidator jweValidator, DynamoDbRepo dynamoDbRepo, AuthUtils util, Gson gson,RedisUtils redisUtils, CommonUtils commonUtils) {
	...
	public String validate2(String jwtToken, String invokedFunctionArn) throws Exception {
		...
		try {
			...
			JWTPayload jwtPayload = jweValidator.validateToken(jwtToken, region_current, null, null, null);
	...
	public Map<String, String> validateAdv(String jwtToken, String invokedFunctionArn, APIGatewayProxyRequest input)throws Exception {
		...
		try {
			...
			JWTPayload jwtPayload = jweValidator.validateToken(jwtToken, region_current, invokedFunctionArn, accountId, null);
			String newEncryptedJWT = null;
	...
	public Response validateTokenDiffRegion(String token, String invokedFunctionArn, APIGatewayProxyRequest input) throws Exception {
		...
		try {
			...
			JWTPayload jwtPayload = jweValidator.validateToken(token, region_current, invokedFunctionArn, accountId, null);
